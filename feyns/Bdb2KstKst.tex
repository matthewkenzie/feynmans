...
\begin{axopicture}(190,140)
  ...
  % B meson                                       
  \Text(160,129)[rb]{$\dquark$}                   % quark Label
  \Line[arrow](106,100.5)(165,130)                % quark Line
  \Text(160,84)[rt]{$\squarkbar$}                 % anti-quark Label
  ...
  \Text(160,11)[rt]{$\dquarkbar$}                 % anti-quark Label
